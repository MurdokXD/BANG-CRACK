...
for xd in range(10000):
	...
	d='RMX2144 Build/RKQ1.201217.002; wv)'
	e=random.randrange(100, 9999)
	f='AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.71'
	g=random.randrange(1, 9)
	h=random.randrange(1, 4)
	i=random.randrange(1, 4)
	j=random.randrange(1, 4)
	k='Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/375.1.0.28.111;]'
...
def banner():
	...
	sol().print(cik2)
	ban='''
•   AUTHOR : MURDOCK-XD WHATSAPP : 081283014147   •
...
•                                               •
•   GITHUB : HTTPS://GITHUB.COM/MURDOCK-XD/007   •'''
